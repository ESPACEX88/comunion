...
export const PSALMS_PLAN: Plan = {
  id: PSALMS_PLAN_ID,
  title: 'Salmos para el camino',
  subtitle: 'Siete días junto al salterio',
  description:
    'Un tramo corto para leer despacio, en voz alta si se puede. Pensado para el grupo: un salmo al día, sin prisa.',
